    ...
    <form  @submit.prevent="handleSubmit"  class="form-group m-3"> <!-- formulaire -->
          ...
          <div class="form-group">
              <label for="InputName"></label>
                <input name="InputName" type="text" class="form-control" id="InputName" v-model="InputName" placeholder="Entrez votre nom"  required>
          </div>
          <div class="form-group">
              <label for="InputLastName"></label>
                <input   name="InputLastName"   type="text" class="form-control" id="InputLastName"  v-model="InputLastName" placeholder="Entrez votre prénom" required>
          </div>
          <div class="form-group">
                <label for="InputEmail"></label>
                <input  name="InputEmail" type="email" class="form-control" id="InputEmail"  v-model="InputEmail" aria-describedby="emailHelp" placeholder="Entrez votre email" required>
          </div>
          <div class="form-group">
